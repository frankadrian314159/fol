...
multiplicatively toward native. Attacking allocation first is not arbitrary: it
...
measures---and it is the prerequisite for the arithmetic work. As an allocation
optimization, ASR is complete on these benchmarks; the remaining distance is a
separate, larger axis of work.
