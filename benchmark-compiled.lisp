;;; 100-iteration benchmark with pre-compiled lsim
...
;; Pre-compile lsim.lisp and register-8bit.lisp
(format t "Pre-compiling lsim.lisp...~%")
(compile-file "fol-code/lsim.lisp" :verbose nil :print nil)
(format t "Pre-compiling register-8bit.lisp...~%")
(compile-file "fol-code/register-8bit.lisp" :verbose nil :print nil)

;; Load compiled fasls
(format t "Loading compiled fasls...~%")
(load (compile-file-pathname "fol-code/lsim.lisp"))
...
(load (compile-file-pathname "fol-code/register-8bit.lisp"))
...
(format t "~%=== 100-Iteration Benchmark (Pre-compiled fasls) ===~%")
(format t "Warming up...~%")
(run-one-simulation)
(sb-ext:gc :full t)
...
(let ((times '())
  ...
  (let* ((end-bytes (sb-ext:get-bytes-consed))
    ...
    (format t "~%Results (100 iterations, pre-compiled):~%")
