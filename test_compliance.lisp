  ...
  (COND
   ((>
     (IF (FBOUNDP 'TRADE-TOTAL-PRICE)
         ...
         (LET ((#3=#:VAL278 TRADE-TOTAL-PRICE))
           (COND ((FUNCTIONP #3#) (FUNCALL #3# . #2#))
                 ((TYPEP #3# '<DICT>) (GET #3# . #2#))
                 ((TYPEP #3# '<VECTOR>) (NTH #3# . #2#))
                 ((TYPEP #3# '<SET>) (GET #3# . #2#))
...
(DEFUN VALIDATE-TRADE #1=(TRD)
  (DECLARE (SPECIAL TRADE-SYMBOL TRD))
  (COND
