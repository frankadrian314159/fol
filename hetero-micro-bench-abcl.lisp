;;; Micro-benchmark: heterogeneous types (ABCL version)
;;; Compares dispatch caching across SBCL, CCL, and ABCL
...
(defun run-all-benchmarks ()
  "Run all benchmarks"
  (format t "~&=== ABCL Dispatch Caching Micro-Benchmark ===~%")
