;;; Transpile lsim.fol to lsim.lisp
...
(transpile-fol-file "fol-code/lsim.fol" "fol-code/lsim.lisp")
(format t "~%Transpilation complete: fol-code/lsim.fol -> fol-code/lsim.lisp~%")
(quit)
