...
| :--- | :--- | :--- | :--- |
| **Real Time** | 0.048 seconds | 0.389 seconds | **~8.10x** |
| **Processor Cycles** | 0.11 billion | 0.89 billion | **~8.09x** |
| **Bytes Consed** | 21.71 MB | 181.97 MB | **~8.38x** |
| **CPU Utilization** | 97.92% | 100.51% | - |
