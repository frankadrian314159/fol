;;;; Clozure CL Phase 1 Validation - Simple (no full system load)
;;;; This test runs dispatch caching tests without loading the entire FOL compiler
;;;; Run: ccl -l ccl-phase1-simple.lisp
...
(format t "~%=== CLOZURE CL DISPATCH CACHING PHASE 1 VALIDATION ===%~%")
(format t "Clozure CL Version: ~A~%" (lisp-implementation-version))
...
(format t "~%✅ CLOZURE CL PHASE 1 VALIDATION COMPLETE~%")
(format t "~%All tests passed on Clozure CL ~A~%" (lisp-implementation-version))
(quit)
