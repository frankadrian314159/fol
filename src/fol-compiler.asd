...
(defsystem "fol-compiler"
  ...
  :components ((:file "version")
               ...
               (:file "summaries" :depends-on ("package"))
               (:file "world" :depends-on ("package"))
               (:file "escape-analysis" :depends-on ("package" "ast" "summaries" "persistence"))
               ...
               (:file "array-functions" :depends-on ("package" "collections" "collection-primitives" "collection-functions"))
               (:file "adverbs" :depends-on ("package" "collections" "collection-primitives" "collection-functions" "array-functions"))
               (:file "advanced-array-operations" :depends-on ("package" "collections" "collection-functions" "seq-functions"))
               (:file "compiler" :depends-on ("package" "primitives" "ast" "destructure" "persistence" "collections" "collection-functions" "seq-functions" "reader" "summaries" "escape-analysis" "world"))
               (:file "interprocedural-types" :depends-on ("compiler" "package" "ast" "escape-analysis" "world"))
               (:file "macros" :depends-on ("compiler" "interprocedural-types" "package" "primitives" "collections" "collection-functions" "seq-functions" "streams" "metadata" "mutable"))
...
(defsystem "fol-compiler/tests"
           ...
           :components ((:module "tests"
                                 ...
                                 ((:file "compiler-tests-package")
                                  ...
                                  ;; (:file "test-persistence" :depends-on ("compiler-tests-package")) ; SBCL metaclass issue
                                  ...
                                  ;; (:file "test-metadata" :depends-on ("compiler-tests-package")) ; SBCL metaclass issue
                                  ...
                                  (:file "test-escape-summaries" :depends-on ("compiler-tests-package"))
                                  ...
                                  (:file "test-reduce-literal-unroll" :depends-on ("compiler-tests-package"))
                                  (:file "test-interprocedural-types" :depends-on ("compiler-tests-package"))
